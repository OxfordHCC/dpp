...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/eslint-loader/dist/cjs.js?!./src/workers/intersection.worker.js":
/*!***********************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--6-oneOf-1!./node_modules/eslint-loader/dist/cjs.js??ref--5-0!./src/workers/intersection.worker.js ***!
  \***********************************************************************************************************************************************/
/*! no exports provided */
...
onmessage = evt => {
  ...
  const toCartesian = (entry, i) => Object.assign({}, {
    r: entry.accuracy || entry.radius,
    originalIndex: i
  }, Object(_lib_geometry_js__WEBPACK_IMPORTED_MODULE_0__["latLongToCartesian"])(entry.latitude, entry.longitude, stdPll));

  const toLatLng = point => Object.assign({}, Object(_lib_geometry_js__WEBPACK_IMPORTED_MODULE_0__["cartesianToLatLong"])(point.x, point.y, stdPll));

  const paths = entries.map(toCartesian).reduce((acc, curr, i, src) => {
    if (i === 0) {
      return acc;
    }
  ...
  const processed = (Object(_lib_geometry_js__WEBPACK_IMPORTED_MODULE_0__["getIntersections"])(paths, cartesianDevices) || []).filter((x, i, arr) => {
...
/******/ });
//# sourceMappingURL=1.chunk.worker.js.map